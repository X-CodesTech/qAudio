...
// Make uploads directory publicly accessible - critical for audio player access
...
(async () => {
  ...
  // Initialize Socket.io server for buzzer functionality
  const io = setupSocketIOServer(server);
  console.log('Socket.io server initialized for buzzer functionality');
