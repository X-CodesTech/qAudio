...
import { Mic, Headphones, MessageCircle, Clock, Volume2, AlertCircle, Phone, PhoneOff, PhoneForwarded } from 'lucide-react';
...
/**
 * Wrapper component to provide CountdownContext
 */
export default function TalentTestA() {
  return (
    <CountdownProvider>
      <TalentTestAInner />
    </CountdownProvider>
...
/**
 * Enhanced test page for Talent Studio A
 * Includes buzzer functionality and a more comprehensive talent interface
 */
function TalentTestAInner() {
  const [currentTime, setCurrentTime] = useState(new Date());
  const [inputLevel, setInputLevel] = useState(0);
  const [outputLevel, setOutputLevel] = useState(0);
  const [message, setMessage] = useState('');
  const [chatMessages, setChatMessages] = useState([
    { id: 1, sender: 'Producer', text: 'Welcome to Studio A!' },
    { id: 2, sender: 'Producer', text: 'Your show starts in 5 minutes.' },
  ]);
  
  // Phone line states
  const [callLines, setCallLines] = useState([
    { id: 1, status: 'inactive', caller: '', phoneNumber: '', onHold: false, onAir: false },
    { id: 2, status: 'ringing', caller: 'John Smith', phoneNumber: '555-1234', onHold: false, onAir: false },
    { id: 3, status: 'active', caller: 'Mary Johnson', phoneNumber: '555-5678', onHold: true, onAir: false },
  ]);
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      setChatMessages(prev => [
        ...prev,
        { id: prev.length + 1, sender: 'Producer', text: 'Message received!' }
      ]);
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-zinc-100 p-4">
      <div className="max-w-6xl mx-auto">
        <header className="bg-orange-500 text-white p-4 rounded-t-lg flex items-center justify-between">
          <div className="flex items-center">
            <Mic className="h-6 w-6 mr-2" />
            <h1 className="text-2xl font-bold">Studio A - Talent Dashboard</h1>
          </div>
          <div className="flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Card className="bg-zinc-800 border-orange-500 border">
              <CardHeader>
                <CardTitle className="flex items-center text-white">
                  <AlertCircle className="h-5 w-5 mr-2 text-orange-500" />
                  Producer Alert System
                </CardTitle>
                <CardDescription className="text-zinc-300">Use the buzzer to alert the producer</CardDescription>
              </CardHeader>
            ...
            <Tabs defaultValue="audio" className="w-full">
              ...
              <TabsContent value="audio" className="mt-0">
                <Card className="bg-zinc-800 border-orange-500 border">
                  <CardHeader>
                    <CardTitle className="text-white">Audio Monitoring</CardTitle>
                    <CardDescription className="text-zinc-300">Monitor your microphone levels and headphone output</CardDescription>
                  </CardHeader>
                    ...
                    <div className="space-y-2">
                      ...
                      <Progress value={inputLevel} max={100} className="h-3" 
                        style={{
                          ...
                          // Using a data attribute instead of CSS variable for proper typing
              ...
              <TabsContent value="chat" className="mt-0">
                <Card className="bg-zinc-800 border-orange-500 border">
                  <CardHeader>
                    <CardTitle className="text-white">Chat with Producer</CardTitle>
                    <CardDescription className="text-zinc-300">Send and receive messages from your producer</CardDescription>
                  </CardHeader>
                  <CardContent>
          ...
          <div className="space-y-4">
            <Card className="bg-zinc-800 border-orange-500 border">
              <CardHeader>
                <CardTitle className="text-white">Countdown Timer</CardTitle>
                <CardDescription className="text-zinc-300">Time remaining in current segment</CardDescription>
              </CardHeader>
              <CardContent>
                {/* Using our StandaloneTimer component in talent mode */}
                <div className="h-32">
                  <StandaloneTimer 
                    variant="talent" 
                    studio="A" 
            ...
            <Card className="bg-zinc-800 border-orange-500 border">
              <CardHeader>
                <CardTitle className="text-white">On-Air Status</CardTitle>
                <CardDescription className="text-zinc-300">Current microphone status</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-zinc-800 border-orange-500 border">
              <CardHeader>
                ...
                <CardDescription className="text-zinc-300">Live phone line status</CardDescription>
              </CardHeader>
            ...
            <Card className="bg-zinc-800 border-orange-500 border">
              <CardHeader>
                ...
                <CardDescription className="text-zinc-300">Important show information</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="list-disc pl-5 space-y-2">
                  <li>Morning show theme: "Summer Events"</li>
                  <li>Call-in segment at 8:30 AM</li>
                  <li>Weather update at 8:45 AM</li>
                  <li>News headlines at 9:00 AM</li>
                </ul>
              </CardContent>
            </Card>
          </div>
        ...
        <footer className="mt-4 text-center text-zinc-500 text-sm">
          QCaller Studio - Talent View (Studio A) - v1.0
        </footer>
      </div>
    </div>
  );
